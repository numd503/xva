...
class CVA():
    ...
    def discount_factor_for_future_payments(self, forward_df: pd.DataFrame, short_rate_array: np.array, t:float, T :float, payment_frequency:float, 
        ...
        # Discount factor for a given period t
        P_0_t       = discount_factor_array[starting_i]   # Zero-coupon bond starting at t=0, with maturity T
        # Forward rate for a given period t
        f_0_t       = forward_df.values[starting_i, 0]
        # All generated Hull-White Short Rates for given period t
    ...
    def interest_rate_swap_valuation_vectorised(self, Notional:int, Floating_rate:np.array, \
        ...
        if V_for_Float_Leg:
            ...
            IRS_value = sum_npv_fix - sum_npv_floating
...
# df_eur3m_last, df_eonia3m_last, df_SOFR3m_last, df_SOFR3m_last_spread
# intrabank_short_rate_3m, rfr_short_rate_3m, rfr_short_rate_3m_sofr, intrabank_short_rate_3m_sofr
# df_eur3m_lastIdx, df_eonia3m_lastIdx, sofr3M